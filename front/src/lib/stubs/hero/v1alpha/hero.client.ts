...
/**
 * @generated from protobuf service task.v1alpha.HeroCRUDService
 */
export interface IHeroCRUDServiceClient {
    /**
     * @generated from protobuf rpc: Get(task.v1alpha.GetRequest) returns (task.v1alpha.GetResponse);
     */
    get(input: GetRequest, options?: RpcOptions): UnaryCall<GetRequest, GetResponse>;
    /**
     * @generated from protobuf rpc: Add(task.v1alpha.AddRequest) returns (task.v1alpha.AddResponse);
     */
    add(input: AddRequest, options?: RpcOptions): UnaryCall<AddRequest, AddResponse>;
    /**
     * @generated from protobuf rpc: Update(task.v1alpha.UpdateRequest) returns (task.v1alpha.UpdateResponse);
     */
    update(input: UpdateRequest, options?: RpcOptions): UnaryCall<UpdateRequest, UpdateResponse>;
    /**
     * @generated from protobuf rpc: Delete(task.v1alpha.DeleteRequest) returns (task.v1alpha.DeleteResponse);
     */
