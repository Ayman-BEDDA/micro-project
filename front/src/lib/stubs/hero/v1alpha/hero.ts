...
// @generated from protobuf file "hero/v1alpha/hero.proto" (package "task.v1alpha", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message task.v1alpha.Hero
 */
...
/**
 * @generated from protobuf message task.v1alpha.GetRequest
 */
...
/**
 * @generated from protobuf message task.v1alpha.GetResponse
 */
export interface GetResponse {
    /**
     * @generated from protobuf field: repeated task.v1alpha.Hero heroes = 1;
     */
    heroes: Hero[];
}
/**
 * @generated from protobuf message task.v1alpha.AddRequest
 */
...
/**
 * @generated from protobuf message task.v1alpha.AddResponse
 */
export interface AddResponse {
    /**
     * @generated from protobuf field: task.v1alpha.Hero hero = 1;
     */
    hero?: Hero;
}
/**
 * @generated from protobuf message task.v1alpha.UpdateRequest
 */
export interface UpdateRequest {
    ...
    id: number;
    /**
     * @generated from protobuf field: int32 power = 4;
     */
    power: number;
    /**
     * @generated from protobuf field: int32 hp = 5;
     */
    hp: number;
}
/**
 * @generated from protobuf message task.v1alpha.UpdateResponse
 */
...
/**
 * @generated from protobuf message task.v1alpha.DeleteRequest
 */
...
/**
 * @generated from protobuf message task.v1alpha.DeleteResponse
 */
...
/**
 * @generated MessageType for protobuf message task.v1alpha.Hero
 */
export const Hero = new Hero$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetRequest$Type extends MessageType<GetRequest> {
    constructor() {
        super("task.v1alpha.GetRequest", [
            { no: 1, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "id", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
...
class GetResponse$Type extends MessageType<GetResponse> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetResponse): GetResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated task.v1alpha.Hero heroes */ 1:
    ...
    internalBinaryWrite(message: GetResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated task.v1alpha.Hero heroes = 1; */
...
class UpdateRequest$Type extends MessageType<UpdateRequest> {
    ...
    internalBinaryWrite(message: UpdateRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* int32 power = 4; */
        if (message.power !== 0)
            writer.tag(4, WireType.Varint).int32(message.power);
        /* int32 hp = 5; */
        if (message.hp !== 0)
            writer.tag(5, WireType.Varint).int32(message.hp);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message task.v1alpha.DeleteResponse
 */
export const DeleteResponse = new DeleteResponse$Type();
/**
 * @generated ServiceType for protobuf service task.v1alpha.HeroCRUDService
 */
export const HeroCRUDService = new ServiceType("task.v1alpha.HeroCRUDService", [
