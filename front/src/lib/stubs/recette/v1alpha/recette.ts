...
/**
 * @generated from protobuf message hero.v1alpha.Recette
 */
export interface Recette {
    ...
    id: number;
    /**
     * @generated from protobuf field: int32 recette = 3;
     */
    recette: number;
    /**
     * @generated from protobuf field: string ingredients = 4;
     */
    ingredients: string;
}
/**
...
export interface GetResponse {
    /**
     * @generated from protobuf field: hero.v1alpha.Recette recette = 1;
     */
    recette?: Recette;
}
/**
...
class Recette$Type extends MessageType<Recette> {
    constructor() {
        super("hero.v1alpha.Recette", [
            { no: 1, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "id", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 3, name: "recette", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 4, name: "ingredients", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<Recette>): Recette {
        const message = { name: "", id: 0, recette: 0, ingredients: "" };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int32 id */ 2:
                    ...
                    break;
                case /* int32 recette */ 3:
                    message.recette = reader.int32();
                    break;
                case /* string ingredients */ 4:
    ...
    internalBinaryWrite(message: Recette, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* int32 recette = 3; */
        if (message.recette !== 0)
            writer.tag(3, WireType.Varint).int32(message.recette);
        /* string ingredients = 4; */
        if (message.ingredients !== "")
            writer.tag(4, WireType.LengthDelimited).string(message.ingredients);
...
/**
 * @generated MessageType for protobuf message hero.v1alpha.Recette
 */
...
class GetResponse$Type extends MessageType<GetResponse> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetResponse): GetResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* hero.v1alpha.Recette recette */ 1:
    ...
    internalBinaryWrite(message: GetResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* hero.v1alpha.Recette recette = 1; */
        if (message.recette)
