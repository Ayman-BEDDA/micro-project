...
import {
	...
	TaskServiceClient,
	UsageServiceClient
} from '$lib/proto/task/v1beta/service.client';
import fs from 'fs';
import { UserServiceClient } from '$src/lib/proto/user/v1alpha/service.client';
import { AuthServiceClient } from '$src/lib/proto/auth/v1alpha/service.client';
